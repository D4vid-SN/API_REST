...
class VistaCancion(Resource):
    ...
    def put(self, id_cancion):
        ...
        cancion.titulo = request.jason.get('titulo', cancion.titulo)
        cancion.minutos = request.jason.get('minutos', cancion.minutos)
        cancion.segundos = request.jason.get('segundos', cancion.segundos)
        cancion.interprete = request.jason.get('interprete', cancion.interprete)
        db.session.commit()
